...
//     alert("Snagged successfully! ✅");
//     window.location.href = "index.html"; // or redirect wherever
//   } catch (err) {
//     console.error("Error:", err);
//     alert("Failed to snag stock 😢 " + err.message);
//   }
...
//   const payload = {
//     ticker_symbol: document.getElementById("ticker_symbol").value,
//     company_name: localStorage.getItem("company_name") || "", // from local storage
//     price: parseFloat(document.getElementById("buy_price").value),
//     quantity: parseInt(document.getElementById("quantity").value),
//     notes: document.getElementById("notes").value || ""
//   };
...
//     alert("Snagged successfully! ✅");
//     window.location.href = "index.html"; // Go back to home or stock list
//   } catch (err) {
//     console.error("Error:", err);
//     alert("Failed to snag stock 😢 " + err.message);
//   }
